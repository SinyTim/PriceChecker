...
public class BasketActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.i("Basket Activity", "onCreate");
    ...
    protected void onStart() {
        super.onStart();
        Log.i("Basket Activity", "onStart");
    }

    @Override
    protected void onStop() {
        super.onStop();
        Log.i("Basket Activity", "onStop");
    }

    @Override
    public void finish() {
        super.finish();
        Log.i("Basket Activity", "finish");
    }

    @Override
    protected void onDestroy() {
        super.onDestroy();
        Log.i("Basket Activity", "onDestroy");
    }

    @Override
    protected void onResume() {
        super.onResume();
        Log.i("Basket Activity", "onResume");
    }

    @Override
    protected void onPause() {
        super.onPause();
        Log.i("Basket Activity", "onPause");
    }

    @Override
    protected void onRestart() {
        super.onRestart();
        Log.i("Basket Activity", "onRestart");
    }
}
